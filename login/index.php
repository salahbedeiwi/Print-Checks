...
<html>
	...
	<?php 
		...
		$getClientInfo = mysql_query("select * from `it_team` where id = $buz_id and active =1 LIMIT 1");
...
<head>
	<meta charset="UTF-8">
	<?php
		$title = "Print Custom Checks, Muliple accounts, Many Users, Many Customers, Cheapest Custom Print Software, Cloud print custom checks | Salah Bedeiwi";
		$keywords = "";
		$desc = "";
		if(isset($_GET['home'])){ // see home page
			$title="Print Custom Checks | Salah Bedeiwi";
			$keywords = "";
			$desc = "";
		}else{
			$title="Print Custom Checks | Salah Bedeiwi";
