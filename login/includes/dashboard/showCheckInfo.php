<div class="loader" id="loading">
	<img src="style/img/loader.gif" id="#loading-image" class="img-responsive center-block" alt="loading Image" />
</div>
<div id="hideAndShow">
	...
	<div class="col-sm-12">
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					  <div class="modal-header modelHeader">
						<h3 class="modal-title" id="myModalLabel">View Check(s) 
						  <span class="glyphicon glyphicon-print pull-right f-smalled"  onclick="printContent('printCheck')"></span> 
						</h3>
					  </div>
		...
		<form  class="form-horizontal" method="post" action="<?php $_SERVER['PHP_SELF']?>"  enctype="multipart/form-data" >
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					  ...
					  <div class="modal-body aliceblue  table-responsive">
						  <?php 
		...
		<form class="form-horizontal" method="" action="">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					  <div class="modal-header modelHeader">
						<h3 class="modal-title" id="myModalLabel">Print Current Check 
							<span class="glyphicon glyphicon-print pull-right f-smalled"  onclick="printContent('printCheck')"></span> 
						 </h3>
					  </div>
					  <div class="modal-body aliceblue checkSection1  hidden-xs " id="printCheck1">
