...
<div id="hideAndShow">
	...
	<ol class="breadcrumb">
	  ...
	  <li class="active"><a href="index.php?viewAllChecks">Print Check(s)</a></li>
	  <li class="active">Create Check(s)</li>
	</ol>	
					  ...
					  <div class="modal-body aliceblue">
							  ...
							  <?php
								if(isset($_POST['printCheckNowBtn'])){
									...
									$findIfClientNewNumberIsFound = mysql_query("select  *  from `create_check` where rand_id = '$rand_check_id'") or die("Error: Generating an admin number -> ".mysql_error());
